package com.dappcloud.humanspace.AdapterClasses.ChatsAdapter;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ChatAdapter.ViewHolder holder, int position) {
        ...
        holder.show_image.setOnClickListener(v -> Toast.makeText(mContext, "Show Image", Toast.LENGTH_SHORT).show());
    }
