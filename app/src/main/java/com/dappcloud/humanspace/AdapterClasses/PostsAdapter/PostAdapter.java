...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView post, like, dislike, comment, verified;
        public ProgressBar progressBar;
        public CircleImageView image_profile;
        public TextView name, username, likes_count, dislikes_count, publisher, caption, comments_count, time;
    ...
    private void publisherInfo(CircleImageView image_profile, TextView username, TextView publisher, ImageView verified, String userid) {
    ...
    private void addNotifications(String userId) {
        ...
        hashMap.put("text", "liked your Image post");
