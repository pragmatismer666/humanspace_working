...
import com.dappcloud.humanspace.User.Infrastructure.Fragments.DisplayVideoFragment;
...
public class GridVideoAdapter extends RecyclerView.Adapter<GridVideoAdapter.ViewHolder>{
    ...
    public GridVideoAdapter(Context mContext, List<Post> mPost) {
    ...
    @NonNull
    @Override
    public GridVideoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_grid_view_item, parent, false);
        return new GridVideoAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GridVideoAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new DisplayVideoFragment()).addToBackStack(null).commit();
